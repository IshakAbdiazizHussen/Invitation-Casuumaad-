  ...
  return (
    <div className='bg-gradient-to-br from-amber-50 via-emerald-50 to-cyan-50 min-h-screen px-4 sm:px-6 lg:px-8 animate-enter'>
        <section className='text-center mt-20'>
            ...
            <div className='mt-10 flex flex-col items-center gap-6 lg:mt-20 lg:flex-row lg:justify-center lg:gap-12 animate-enter-delay-1'>
              {testimonials.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full max-w-md min-h-56 rounded-2xl border bg-white p-8 text-left shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${
            ...
            <div className='mx-auto mt-8 w-full max-w-4xl rounded-2xl border border-emerald-200 bg-white p-6 text-left shadow-lg animate-enter-delay-2'>
